...
export class DeviceSelector extends React.Component<
  P,
  {
...
> {
  ...
  async componentWillMount() {
    ...
    const selected =
      devices.find(d => d.deviceId === this.props.defaultId) || devices[0];
    this.setState({
      devices,
    ...
    try {
      const stream = await setUserMedia(
        this.props.cameraWidth,
        this.props.cameraHeight,
        selected.deviceId
      );
